...
#ifndef SHT85_BCM2835_H
#define SHT85_BCM2835_H
...
// replace or extend this with Reason Codes
// ensure error matches bcm errors
typedef enum{
  NO_ERROR       = BCM2835_I2C_REASON_OK, // no error
  ACK_ERROR      = BCM2835_I2C_REASON_ERROR_NACK, // no acknowledgment error
  CHECKSUM_ERROR = 0x08, 
  TIMEOUT_ERROR  = BCM2835_I2C_REASON_ERROR_CLKT, // timeout error
  DATA_ERROR = BCM2835_I2C_REASON_ERROR_DATA,
} etError;
